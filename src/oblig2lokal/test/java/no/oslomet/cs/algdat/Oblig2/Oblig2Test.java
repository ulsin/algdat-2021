package oblig2lokal.test.java.no.oslomet.cs.algdat.Oblig2;

import oblig2lokal.main.java.no.oslomet.cs.algdat.Oblig2.DobbeltLenketListe;
import oblig2lokal.main.java.no.oslomet.cs.algdat.Oblig2.Liste;
...
class Oblig2Test {
    ...
    void oppgave6() {
        ...
        System.out.println("Tid for verdi: " + tid1);

        for (int i = 1; i <= 100_000; i++) nyliste.leggInn(i);
        long tid2 = System.currentTimeMillis();
        for (int i = 40000; i <= 50000; i++) nyliste.fjern(i);
        tid2 = System.currentTimeMillis() - tid2;
        System.out.println("Tid for index: " + tid2);
        System.out.println("Rate: " + (double)tid1/tid2);
...
//            System.out.println("Min: " + min + " Maks: " + maks + " Rate: " + (double)maks/min);
            antallFeil++;
        }
    }
